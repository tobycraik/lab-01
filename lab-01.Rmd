...
#How many tourist attractions are there in the data set? - 348
...
**Not Available - some of the values in n_2021 are NA and not numbers as there are no values for that year**
...
**na.rm ignores the values of NA in the data and calculates the rest**
...
**Some sites have a high number of visitors which pulls the average up but the majority of sites have a smaller number so the median is lower. **
